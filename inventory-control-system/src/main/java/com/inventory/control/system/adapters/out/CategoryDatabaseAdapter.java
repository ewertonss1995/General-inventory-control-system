...
public class CategoryDatabaseAdapter implements CategoryRepositoryPort {
    ...
    public CategoryDatabaseAdapter(CategoryMapper mapper, MongoCategoryRepository repository, MeterRegistry meterRegistry) {
        this.mapper = mapper;
    ...
    public Category saveCategory(Category category) {
        return executeWithTimer("save", () -> {
            ...
            try {
                ...
                recordDatabaseError("save", e.getClass().getSimpleName());
    ...
    public Category updateCategory(Category category) {
        return executeWithTimer("update", () -> {
            ...
            try {
                ...
                recordDatabaseError("update", e.getClass().getSimpleName());
    ...
    public boolean existsById(String id) {
        return executeWithTimer("existsById", () -> {
            ...
            try {
                ...
                recordDatabaseError("existsById", e.getClass().getSimpleName());
    ...
    public List<Category> findAll() {
        return executeWithTimer("findAll", () -> {
            ...
            try {
                ...
                recordDatabaseError("findAll", e.getClass().getSimpleName());
    ...
    public Optional<Category> findById(String id) {
        return executeWithTimer("findById", () -> {
            ...
            try {
                ...
                recordDatabaseError("findById", e.getClass().getSimpleName());
    ...
    private <T> T executeWithTimer(String operation, Supplier<T> supplier) {
        return Timer.builder("db.mongodb.category.query.time")
                .description("Tempo de execução de consulta de categoria no MongoDB")
                .tag("layer", "adapter")
    ...
    private void recordDatabaseError(String operation, String exceptionType) {
        meterRegistry.counter("db.mongodb.category.errors",
                "layer", "adapter",
                "operation", operation,
                "exception", exceptionType,
                "db", "mongodb").increment();
    }
}
