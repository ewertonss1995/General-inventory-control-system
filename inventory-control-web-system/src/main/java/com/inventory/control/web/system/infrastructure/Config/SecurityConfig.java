...
import com.study.inventory.control.web.system.infrastructure.security.JwtAuthoritiesConverter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers(HttpMethod.POST, "/api/web/auth/login", "/api/web/auth/register").permitAll()
